...
<style>
    ...
    .status-opt.blocked:has(input:checked) {
            ...
            <form action="{{ route('backend.produk.update', $edit->id) }}" method="post"
                ...
                <div class="produk-form-layout">
                    ...
                    <div class="form-left-col">
                        <div class="field-group">
                            ...
                            <div class="upload-zone has-preview" id="uploadZone">
                                ...
                                @if ($edit->foto)
                                    <img class="foto-preview" id="fotoPreview"
                                         ...
                                         alt="Foto {{ $edit->nama_produk }}">
                                @else
                                    <img class="foto-preview" id="fotoPreview"
                                         src="{{ asset('storage/img-produk/imgdefault.jpg') }}"
                                         alt="Default Foto">
                                @endif
                            ...
                            @error('foto')
                                <div class="d-block" style="font-size:0.72rem;color:var(--rose);font-weight:600;margin-top:4px;">
                        ...
                        {{-- Tips --}}
                        <div style="margin-top:16px;padding:12px 14px;background:var(--amber-light);border-radius:var(--radius-md);border:1px solid rgba(200,134,42,0.25);">
                            <div style="font-size:0.73rem;font-weight:700;color:var(--amber);margin-bottom:6px;">
                    ...
                    <div class="form-right-col">
                        ...
                        {{-- Status --}}
                        <div class="field-group">
                            <label><i class="ri-toggle-line" style="margin-right:4px;"></i>Status Produk</label>
                            <div class="status-selector">
                                <label class="status-opt">
                                    <input type="radio" name="status" value="1"
                                           {{ old('status', $edit->status) == '1' ? 'checked' : '' }}>
                                    <i class="ri-checkbox-circle-line"></i> Public
                                </label>
                                <label class="status-opt blocked">
                                    <input type="radio" name="status" value="0"
                                           {{ old('status', $edit->status) == '0' ? 'checked' : '' }}>
                                    <i class="ri-close-circle-line"></i> Blok
                                </label>
                            </div>
                            @error('status')
                                <div style="font-size:0.72rem;color:var(--rose);font-weight:600;">
                                    <i class="ri-error-warning-line"></i> {{ $message }}
                                </div>
                            @enderror
                        </div>
                        ...
                        <div class="field-group">
                            ...
                            @error('kategori_id')
                                <div style="font-size:0.72rem;color:var(--rose);font-weight:600;margin-top:4px;">
                                    <i class="ri-error-warning-line"></i> {{ $message }}
                                </div>
                            @enderror
                        </div>
                ...
                <div class="form-action-bar">
                    ...
                    <button type="submit" class="btn-save">
                        <i class="ri-save-3-line"></i> Update Produk
                    </button>
                </div>
